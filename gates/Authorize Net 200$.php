...
$gate = "𝘼𝙐𝙏𝙃𝙊𝙍𝙄𝙕𝙀 𝙉𝙀𝙏 200$";
  ...
  //====ANTISPAM AND WRONG FORMAT====//
      if (strlen($message) <= 4) {
              sendMessage($chatId, '!<b>• 𝚈𝚘𝚞 𝙳𝚞𝚖𝚋 𝙰𝚜𝚜 𝙷𝚘𝚕𝚎 ! </b>         𝚃𝚎𝚡𝚝 𝚂𝚑𝚘𝚞𝚕𝚍 𝙾𝚗𝚕𝚢 𝙲𝚘𝚗𝚊𝚝𝚒𝚗 <code>/anh cc|mm|yy|cvv</code>%0A𝙶𝚊𝚝𝚎𝚠𝚊𝚢 - <b>𝘼𝙐𝙏𝙃𝙊𝙍𝙄𝙕𝙀 𝙉𝙀𝙏 200$</b>', $message_id);
              exit();
    }
  $r = "0";
  ...
  $sent_message_id = send_reply($chatId, $message_id, $keyboard, "<b>𝚆𝙰𝙸𝚃 𝙳𝙾𝙸𝙽𝙶 𝚂𝙴𝚇 𝚂𝚄𝚇🎃</b>");
